...
public class ChatActivity extends AppCompatActivity {
    ...
    void callApi(JSONObject jsonObject){
        ...
        Request request = new Request.Builder()
                .url(url)
                .post(body)
                .header("Authorization","Bearer AAAAXVpYJFE:APA91bEOiPnVHGUuYC_cOaaVV18C9IRNPSSlHLClmoTu1tMNAxCUN8GtEiTTIzejMcSYxsh1yX34MBRbrvjn0glATNVtoml6C2Bk-W1tEgYEjJUcKCSHsg6JPjcbIMzx7Di9buzoSiBP")
                .build();
